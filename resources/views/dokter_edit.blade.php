            ...
            <form action="/dokter/{{ $dokter->id }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group mt-3">
                    ...
                    <select name="spesialis" class="form-control">
                        <option value="Ekstrovert" @selected($dokter->spesialis == 'Ekstrovert')> Spesialis Ekstrovert</option>
                        <option value="Introvert" @selected($dokter->spesialis == 'Introvert')> Spesialis Introvert</option>
                        <option value="Intuitif" @selected($dokter->spesialis == 'Intuitif')> Spesialis Intuitif</option>
                        <option value="Fisika" @selected($dokter->spesialis == 'Fisika')> Spesialis Fisika </option>
                    </select>
